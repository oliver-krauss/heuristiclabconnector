...
namespace HeuristicLab.TruffleConnector {
  /// <summary>
  ///   Patched copy of HeuristicLab.Encodings.SymbolicExpressionTreeEncoding.SymbolicExpressionGrammar.
  ///   Treats TruffleSymbols with same name but different ID correctly.
  /// </summary>
  [StorableType("9D959F0C-E636-4B73-B277-9B350906CD4C")]
