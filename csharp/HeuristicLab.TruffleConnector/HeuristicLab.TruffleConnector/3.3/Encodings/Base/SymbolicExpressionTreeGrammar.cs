...
namespace HeuristicLab.TruffleConnector {
  /// <summary>
  ///   Patched copy of HeuristicLab.Encodings.SymbolicExpressionTreeEncoding.SymbolicExpressionTreeGrammar.
  ///   Treats TruffleSymbols with same name but different ID correctly.
  /// </summary>
  [StorableType("702EFB21-F3ED-498F-94AC-0758BF5ED15E")]
  internal sealed class SymbolicExpressionTreeGrammar : SymbolicExpressionGrammarBase, ISymbolicExpressionTreeGrammar {
    ...
    public bool IsModifyableSymbol(ISymbol symbol) {
      return base.symbols.ContainsKey(GetKey(symbol));
    }
